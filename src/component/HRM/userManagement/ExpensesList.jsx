...
const ExpensesList = () => {
  ...
  return (
    <div className='mt-5 ml-10 mr-10 h-screen'>

        <PreviousButton />
        <h3 className='text-bold dark:text-white text-2xl'>Expense Detail's</h3>
...
<div class="overflow-x-auto no-scrollbar shadow-md sm:rounded-lg">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                        ...
                        <button 
                        type="button" 
                        className="text-white bg-pink-700 hover:bg-pink-800 focus:outline-none focus:ring-4 focus:ring-pink-300 font-medium rounded-full text-sm w-full px-5 py-2.5 text-center mr-2 mb-2 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800"
