...
const CAValidationDayReportData = ({selectedDate}) => {
  ...
  const {caOfficeData,
    ...
    const filteredOfficeReports = caOfficeData.filter(
      officeReport=> officeReport.Date === selectedDate)
  
      const filteredSiteReports = caSiteData.filter(
  ...
  return (
    <div>
      <div>
        <div>
          <h3 className='text-bold underline'>CA Validation Office Data</h3>
            {
          ...
          <h3 className='text-bold underline'>CA Validation Site Data</h3>
            {
...
export default CAValidationDayReportData