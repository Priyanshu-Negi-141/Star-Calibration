...
const ThermalValidationCheckIN = () => {
    const officeData = [
        {
          srNum: 1,
          empName: 'John Doe',
  ...
  return (
    ...
    <div>
        <div>
        <div>
          <h3 className='text-bold underline'>Thermal Validation Office Data</h3>
          ...
          <h3 className='text-bold underline'>Thermal Validation Site Data</h3>
          <table className="w-full text-center border-2 border-black/25">
            <thead className='border-2 border-black/25'>
              <tr>
                <th>Sr. Num</th>
