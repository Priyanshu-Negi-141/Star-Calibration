...
const ThemeSettings = () => {
  ...
  return (
    <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0 z-10 overflow-y-scroll no-scrollbar">
      <div
      className="float-right h-screen dark:text-gray-200  bg-white dark:bg-[#484B52]">
        ...
        <p className="font-semibold text-xl ">Break Time</p>
        </div>
        <div className="flex-col border-t-1 border-color p-4 ml-4">
        ...
        <div className="p-4 border-t-1 border-color float-right h-screen dark:text-gray-200  bg-white dark:bg-[#484B52]">
