...
const Miscellnious_SOP = () => {
  ...
  return (
    ...
    <div className=''>
        <div className=''>
            <div className='border border-black p-2 text-center text-bold bg-yellow-400 hover:bg-yellow-500'><h2>Miscellnious SOP Index</h2></div>
...
export default Miscellnious_SOP