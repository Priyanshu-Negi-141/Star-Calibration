...
import { sopHomePageData } from '../../data/Quality/SOP/sopHomePage'
...
const SOP = () => {
  ...
  return (
    <div className=''>
    <h3 className='text-black text-2xl rounded-xl mb-5 p-3 dark:text-yellow-50' style={{color: currentColor, border: '2px solid'}}>SOP Management</h3>
    <div className='flex flex-wrap lg:flex-nowrap justify-center'> 
        <button className='flex m-1 flex-wrap justify-center gap-9 items-center'>
            {
                sopHomePageData.map((item) => (
